...
class Ui(QtWidgets.QMainWindow):
    ...
    def DAC1_square(self):
        ...
        delay_us = int( delay_sec*1000000 )
        print( 'delay_us', delay_us)
        expected_f = 1/(2*delay_us/1000000 + c)
        self.textBrowser.append( 'delay_us set to '  + str( delay_us ))
        self.textBrowser.append( 'expected f = ' + str( expected_f ) )
        test_str = 'DAC1_square'  
        test_str += str( delay_us  )    +  ','   
